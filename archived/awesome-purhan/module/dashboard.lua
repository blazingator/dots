...
local config = buildButton(icons.gear_dark, 'Config')
config:connect_signal('button::release', function()
    dashboard_hide()
    _G.awesome.spawn(apps.default.config)
end)
