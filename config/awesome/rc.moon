...
mainmenu = awful.menu
	items: {
		{"rofi menu", -> awful.spawn "rofi -show drun"}
		{"edit config", -> awful.spawn "nvim-qt +'CocCommand explorer ~/.config/awesome'"}
		{"restart", awful.restart}
		{"quit", awful.quit}
	}

-- mouse bindings
root.buttons gears.table.join(
	awful.button({}, 3, -> mainmenu\show!)
