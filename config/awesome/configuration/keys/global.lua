...
awful.key({'Control', 'Shift'}, 'Print', function()
    ...
    description = 'Mark an area and screenshot it 10 seconds later',
    group = 'screenshots'
}), awful.key({altkey}, 'Print', function()
    awful.util.spawn_with_shell(apps.default.screenshot)
end, {
    description = 'Take a screenshot of your active monitor',
    group = 'screenshots'
}), awful.key({'Control'}, 'Print', function()
    awful.util.spawn_with_shell(apps.default.region_screenshot)
end, {
    description = 'Mark an area and take a screenshot',
    group = 'screenshots'
}),
...
-- Open private browser/vimb
awful.key({modkey}, 'p',
          function() awful.util.spawn_with_shell('vimb') end,
          {description = 'Open VimBrowser', group = 'launcher'}),
-- Standard program
awful.key({modkey}, 't',
          function() awful.util.spawn_with_shell(apps.default.terminal) end,
          {description = 'open a terminal', group = 'launcher'}),
awful.key({modkey}, 'Return',
          function() awful.util.spawn_with_shell('alacritty') end,
...
function() awful.util.spawn_with_shell('alacritty -e bpytop') end, {
